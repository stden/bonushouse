...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserFeedbacks.partner_user'
        db.add_column('bonushouse_userfeedbacks', 'partner_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='moderated_feedbacks', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserFeedbacks.partner_user'
        db.delete_column('bonushouse_userfeedbacks', 'partner_user_id')
