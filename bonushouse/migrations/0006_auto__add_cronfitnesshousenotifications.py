...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CronFitnesshouseNotifications'
        db.create_table('bonushouse_cronfitnesshousenotifications', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('content_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('is_completed', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('fitnesshouse_reply', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('bonushouse', ['CronFitnesshouseNotifications'])


    def backwards(self, orm):
        # Deleting model 'CronFitnesshouseNotifications'
        db.delete_table('bonushouse_cronfitnesshousenotifications')
    ...
    models = {
        ...
        'bonushouse.cronfitnesshousenotifications': {
            'Meta': {'object_name': 'CronFitnesshouseNotifications'},
            'content_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'fitnesshouse_reply': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_completed': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
        ...
        'bonushouse.userprofile': {
            ...
            'referer_checked': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
