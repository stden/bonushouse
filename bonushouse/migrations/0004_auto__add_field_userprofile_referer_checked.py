...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.referer_checked'
        db.add_column('bonushouse_userprofile', 'referer_checked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.referer_checked'
        db.delete_column('bonushouse_userprofile', 'referer_checked')
