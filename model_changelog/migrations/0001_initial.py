...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('model_changelog_logmessage', (
        ...
        db.send_create_signal('model_changelog', ['LogMessage'])


    def backwards(self, orm):
        # Deleting model 'LogMessage'
        db.delete_table('model_changelog_logmessage')
