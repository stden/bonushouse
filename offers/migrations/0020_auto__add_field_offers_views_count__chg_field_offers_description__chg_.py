...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Offers.views_count'
        db.add_column('offers_offers', 'views_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


        # Changing field 'Offers.description'
        db.alter_column('offers_offers', 'description', self.gf('ckeditor.fields.RichTextField')())

        # Changing field 'Offers.terms'
        db.alter_column('offers_offers', 'terms', self.gf('ckeditor.fields.RichTextField')())

    def backwards(self, orm):
        # Deleting field 'Offers.views_count'
        db.delete_column('offers_offers', 'views_count')


        # Changing field 'Offers.description'
        db.alter_column('offers_offers', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Offers.terms'
        db.alter_column('offers_offers', 'terms', self.gf('django.db.models.fields.TextField')())
