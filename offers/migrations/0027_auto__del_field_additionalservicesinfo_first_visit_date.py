...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AdditionalServicesInfo.first_visit_date'
        db.delete_column('offers_additionalservicesinfo', 'first_visit_date')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'AdditionalServicesInfo.first_visit_date'
        raise RuntimeError("Cannot reverse this migration. 'AdditionalServicesInfo.first_visit_date' and its values cannot be restored.")
