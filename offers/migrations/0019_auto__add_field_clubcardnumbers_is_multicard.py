...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClubCardNumbers.is_multicard'
        db.add_column('offers_clubcardnumbers', 'is_multicard',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClubCardNumbers.is_multicard'
        db.delete_column('offers_clubcardnumbers', 'is_multicard')
