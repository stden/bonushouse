...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AdditionalServicesOrder'
        db.create_table('offers_additionalservicesorder', (
            ...
            ('additional_info', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['offers.AdditionalServicesInfo'])),
        ...
        db.send_create_signal('offers', ['AdditionalServicesOrder'])

        # Adding model 'AdditionalServicesInfo'
        db.create_table('offers_additionalservicesinfo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('card_number', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('last_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('first_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('father_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('birth_date', self.gf('django.db.models.fields.DateField')()),
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
        ))
        db.send_create_signal('offers', ['AdditionalServicesInfo'])


    def backwards(self, orm):
        # Deleting model 'AdditionalServicesOrder'
        db.delete_table('offers_additionalservicesorder')

        # Deleting model 'AdditionalServicesInfo'
        db.delete_table('offers_additionalservicesinfo')
