...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GiftOrder.real_order_type'
        db.add_column('offers_giftorder', 'real_order_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'GiftOrder.real_order_id'
        db.add_column('offers_giftorder', 'real_order_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GiftOrder.real_order_type'
        db.delete_column('offers_giftorder', 'real_order_type_id')

        # Deleting field 'GiftOrder.real_order_id'
        db.delete_column('offers_giftorder', 'real_order_id')
    ...
    models = {
        ...
        'offers.giftorder': {
            ...
            'price': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'price_type': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'real_order_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'real_order_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['contenttypes.ContentType']"}),
            'transaction_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'transaction_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']", 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'visitor_info': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['visitor_tracking.VisitorInfo']", 'null': 'True', 'blank': 'True'})
