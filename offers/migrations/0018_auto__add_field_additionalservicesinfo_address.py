...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AdditionalServicesInfo.address'
        db.add_column('offers_additionalservicesinfo', 'address',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['partners.PartnerAddress'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AdditionalServicesInfo.address'
        db.delete_column('offers_additionalservicesinfo', 'address_id')
