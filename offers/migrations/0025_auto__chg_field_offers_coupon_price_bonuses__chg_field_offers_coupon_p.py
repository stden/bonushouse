...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Offers.coupon_price_bonuses'
        db.alter_column('offers_offers', 'coupon_price_bonuses', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Offers.coupon_price_money'
        db.alter_column('offers_offers', 'coupon_price_money', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Offers.coupon_price_bonuses'
        raise RuntimeError("Cannot reverse this migration. 'Offers.coupon_price_bonuses' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Offers.coupon_price_money'
        raise RuntimeError("Cannot reverse this migration. 'Offers.coupon_price_money' and its values cannot be restored.")
    ...
    models = {
        ...
        'offers.additionalservicesorder': {
            'Meta': {'object_name': 'AdditionalServicesOrder'},
            'add_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'additional_info': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['offers.AdditionalServicesInfo']"}),
            'agreement_id': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_completed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'offer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['offers.Offers']"}),
        ...
        'offers.giftorder': {
            'Meta': {'object_name': 'GiftOrder'},
            'add_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'gift_code': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'gift_code_used': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'gift_delivery_email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'gift_delivery_type': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'gift_from_name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'gift_message': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'gift_to_name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_completed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'offer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['offers.Offers']"}),
            'price': ('django.db.models.fields.PositiveIntegerField', [], {}),
        ...
        'offers.metaorder': {
            'Meta': {'object_name': 'MetaOrder'},
            'add_date': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_completed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'order_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'order_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']", 'null': 'True', 'blank': 'True'}),
        ...
        'offers.offers': {
            ...
            'coupon_price_bonuses': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'coupon_price_money': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
