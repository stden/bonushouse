...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AdditionalServicesOrder.agreement_id'
        db.add_column('offers_additionalservicesorder', 'agreement_id',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AdditionalServicesInfo.first_visit_date'
        db.add_column('offers_additionalservicesinfo', 'first_visit_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 1, 22, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AdditionalServicesOrder.agreement_id'
        db.delete_column('offers_additionalservicesorder', 'agreement_id')
