...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'ClubCardNumbers'
        db.delete_table('offers_clubcardnumbers')


    def backwards(self, orm):
        # Adding model 'ClubCardNumbers'
        db.create_table('offers_clubcardnumbers', (
            ('first_chars', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('is_multicard', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('total_chars', self.gf('django.db.models.fields.IntegerField')()),
            ('total_chars_sign', self.gf('django.db.models.fields.CharField')(default='=', max_length=3)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('offers', ['ClubCardNumbers'])
