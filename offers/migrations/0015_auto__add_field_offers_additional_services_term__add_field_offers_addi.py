...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Offers.additional_services_term'
        db.add_column('offers_offers', 'additional_services_term',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Offers.additional_services_term_type'
        db.add_column('offers_offers', 'additional_services_term_type',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Offers.additional_services_term'
        db.delete_column('offers_offers', 'additional_services_term')

        # Deleting field 'Offers.additional_services_term_type'
        db.delete_column('offers_offers', 'additional_services_term_type')
    ...
    models = {
        ...
        'offers.offers': {
            ...
            'additional_services_term_type': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
