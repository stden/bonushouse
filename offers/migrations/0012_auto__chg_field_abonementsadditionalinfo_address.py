...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AbonementsAdditionalInfo.address'
        db.alter_column('offers_abonementsadditionalinfo', 'address_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['partners.PartnerAddress']))

    def backwards(self, orm):

        # Changing field 'AbonementsAdditionalInfo.address'
        db.alter_column('offers_abonementsadditionalinfo', 'address_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['partners.PartnerAddress'], null=True))
