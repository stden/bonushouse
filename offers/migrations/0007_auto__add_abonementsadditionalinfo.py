...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AbonementsAdditionalInfo'
        db.create_table('offers_abonementsadditionalinfo', (
        ...
        db.send_create_signal('offers', ['AbonementsAdditionalInfo'])


    def backwards(self, orm):
        # Deleting model 'AbonementsAdditionalInfo'
        db.delete_table('offers_abonementsadditionalinfo')
