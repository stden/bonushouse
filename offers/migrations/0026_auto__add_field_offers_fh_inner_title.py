...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Offers.fh_inner_title'
        db.add_column('offers_offers', 'fh_inner_title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Offers.fh_inner_title'
        db.delete_column('offers_offers', 'fh_inner_title')
