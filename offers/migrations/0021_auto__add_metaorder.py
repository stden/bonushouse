...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MetaOrder'
        db.create_table('offers_metaorder', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, blank=True)),
            ('order_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
        ...
        db.send_create_signal('offers', ['MetaOrder'])


    def backwards(self, orm):
        # Deleting model 'MetaOrder'
        db.delete_table('offers_metaorder')
