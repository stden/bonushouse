...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GiftOrder'
        db.create_table('offers_giftorder', (
            ...
            ('gift_code', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('gift_code_used', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('gift_from_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('gift_to_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('gift_delivery_type', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('gift_delivery_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True)),
            ('gift_message', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('offers', ['GiftOrder'])


    def backwards(self, orm):
        # Deleting model 'GiftOrder'
        db.delete_table('offers_giftorder')
