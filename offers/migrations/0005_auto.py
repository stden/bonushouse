...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field addresses on 'Offers'
        db.create_table('offers_offers_addresses', (
        ...
        db.create_unique('offers_offers_addresses', ['offers_id', 'partneraddress_id'])


    def backwards(self, orm):
        # Removing M2M table for field addresses on 'Offers'
        db.delete_table('offers_offers_addresses')
