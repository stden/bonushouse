...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AbonementOrder'
        db.create_table('offers_abonementorder', (
            ...
            ('additional_info', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['offers.AbonementsAdditionalInfo'])),
        ...
        db.send_create_signal('offers', ['AbonementOrder'])

        # Adding field 'AbonementsAdditionalInfo.address'
        db.add_column('offers_abonementsadditionalinfo', 'address',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['partners.PartnerAddress'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'AbonementOrder'
        db.delete_table('offers_abonementorder')

        # Deleting field 'AbonementsAdditionalInfo.address'
        db.delete_column('offers_abonementsadditionalinfo', 'address_id')
