...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Offers.abonements_term'
        db.add_column('offers_offers', 'abonements_term',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Offers.abonements_term'
        db.delete_column('offers_offers', 'abonements_term')
