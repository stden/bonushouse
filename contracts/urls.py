...
from contracts.views import prolongate_contract, person_restruct_contract, club_restruct_contract, calculate_price
...
urlpatterns = patterns('',
    ...
    url(r'^prolongate/calculate/$', calculate_price, name='prolongate_calculate_price'),
    )