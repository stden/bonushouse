...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartnerAddress.geocode_latitude'
        db.add_column('partners_partneraddress', 'geocode_latitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PartnerAddress.geocode_longitude'
        db.add_column('partners_partneraddress', 'geocode_longitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartnerAddress.geocode_latitude'
        db.delete_column('partners_partneraddress', 'geocode_latitude')

        # Deleting field 'PartnerAddress.geocode_longitude'
        db.delete_column('partners_partneraddress', 'geocode_longitude')
