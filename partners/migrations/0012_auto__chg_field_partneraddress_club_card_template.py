...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PartnerAddress.club_card_template'
        db.alter_column('partners_partneraddress', 'club_card_template_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['partners.ClubCardNumbers'], null=True))
        # Adding M2M table for field clubs on 'ClubCardNumbers'
        db.create_table('partners_clubcardnumbers_clubs', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('clubcardnumbers', models.ForeignKey(orm['partners.clubcardnumbers'], null=False)),
            ('partneraddress', models.ForeignKey(orm['partners.partneraddress'], null=False))
        ))
        db.create_unique('partners_clubcardnumbers_clubs', ['clubcardnumbers_id', 'partneraddress_id'])


    def backwards(self, orm):

        # Changing field 'PartnerAddress.club_card_template'
        db.alter_column('partners_partneraddress', 'club_card_template_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['offers.ClubCardNumbers'], null=True))
        # Removing M2M table for field clubs on 'ClubCardNumbers'
        db.delete_table('partners_clubcardnumbers_clubs')
    ...
    models = {
        ...
        'partners.clubcardnumbers': {
            ...
            'clubs': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['partners.PartnerAddress']", 'symmetrical': 'False'}),
        ...
        'partners.partneraddress': {
            ...
            'club_card_template': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['partners.ClubCardNumbers']", 'null': 'True', 'blank': 'True'}),
