...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('partners_partneraddress', (
            ...
            ('metro', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.MetroStations'], null=True, blank=True)),
            ('schedule', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('partners', ['PartnerAddress'])

        # Deleting field 'Partner.schedule'
        db.delete_column('partners_partner', 'schedule')

        # Deleting field 'Partner.phone'
        db.delete_column('partners_partner', 'phone')

        # Deleting field 'Partner.address'
        db.delete_column('partners_partner', 'address')

        # Deleting field 'Partner.metro'
        db.delete_column('partners_partner', 'metro_id')


    def backwards(self, orm):
        # Deleting model 'PartnerAddress'
        db.delete_table('partners_partneraddress')

        # Adding field 'Partner.schedule'
        db.add_column('partners_partner', 'schedule',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Partner.phone'
        db.add_column('partners_partner', 'phone',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Partner.address'
        db.add_column('partners_partner', 'address',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Partner.metro'
        db.add_column('partners_partner', 'metro',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.MetroStations'], null=True, blank=True),
                      keep_default=False)
