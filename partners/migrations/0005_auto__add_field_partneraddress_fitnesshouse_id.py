...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartnerAddress.fitnesshouse_id'
        db.add_column('partners_partneraddress', 'fitnesshouse_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartnerAddress.fitnesshouse_id'
        db.delete_column('partners_partneraddress', 'fitnesshouse_id')
