...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        clubs = orm['partners.PartnerAddress'].objects.all()
        for club in clubs:
            if club.club_card_template:
                if club not in club.club_card_template.clubs.all():
                    club.club_card_template.clubs.add(club)
                    club.club_card_template.save()


    def backwards(self, orm):
        "Write your backwards methods here."
        templates = orm['partners.ClubCardNumbers'].objects.all()
        for template in templates:
            template.clubs.clear()
