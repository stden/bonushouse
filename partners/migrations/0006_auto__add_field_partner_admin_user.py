...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Partner.admin_user'
        db.add_column('partners_partner', 'admin_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Partner.admin_user'
        db.delete_column('partners_partner', 'admin_user_id')
