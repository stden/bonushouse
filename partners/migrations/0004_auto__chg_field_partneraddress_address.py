...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PartnerAddress.address'
        db.alter_column('partners_partneraddress', 'address', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'PartnerAddress.address'
        db.alter_column('partners_partneraddress', 'address', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
