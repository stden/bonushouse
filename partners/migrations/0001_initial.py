...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field photos on 'Partner'
        db.create_table('partners_partner_photos', (
        ...
        db.create_unique('partners_partner_photos', ['partner_id', 'uploadedfile_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field photos on 'Partner'
        db.delete_table('partners_partner_photos')
