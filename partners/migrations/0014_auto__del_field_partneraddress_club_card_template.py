...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PartnerAddress.club_card_template'
        db.delete_column('partners_partneraddress', 'club_card_template_id')


    def backwards(self, orm):
        # Adding field 'PartnerAddress.club_card_template'
        db.add_column('partners_partneraddress', 'club_card_template',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['partners.ClubCardNumbers'], null=True, blank=True),
                      keep_default=False)
