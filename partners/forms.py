...
class PartnerForm(forms.ModelForm):
    ...
    admin_user = forms.ModelMultipleChoiceField(label='Пользователь-администратор',queryset=User.objects.all().order_by('username'), widget=forms.CheckboxSelectMultiple(attrs={'padding':'0px'}))
