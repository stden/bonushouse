...
urlpatterns = patterns('',
    ...
    url(r'^offers_prolongation/$', 'administration.views.offers_prolongation_index', name='administration_offers_prolongation_index'),
    url(r'^offers_prolongation/add/$', 'administration.views.offers_prolongation_add', name='administration_offers_prolongation_add'),
    url(r'^offers_prolongation/edit/(?P<offer_id>\d+)/$', 'administration.views.offers_prolongation_edit', name='administration_offers_prolongation_edit'),
    url(r'^offers_prolongation/delete/(?P<offer_id>\d+)/$', 'administration.views.offers_prolongation_delete', name='administration_offers_prolongation_delete'),
