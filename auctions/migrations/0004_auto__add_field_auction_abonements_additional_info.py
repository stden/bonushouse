...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Auction.abonements_additional_info'
        db.add_column('auctions_auction', 'abonements_additional_info',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['offers.AbonementsAdditionalInfo'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Auction.abonements_additional_info'
        db.delete_column('auctions_auction', 'abonements_additional_info_id')
