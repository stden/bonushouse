...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Auction.completed_date'
        db.add_column('auctions_auction', 'completed_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Auction.completed_date'
        db.delete_column('auctions_auction', 'completed_date')
