...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Auction.is_completed'
        db.add_column('auctions_auction', 'is_completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Auction.winner'
        db.add_column('auctions_auction', 'winner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Auction.coupon_code'
        db.add_column('auctions_auction', 'coupon_code',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Auction.coupon_code_used'
        db.add_column('auctions_auction', 'coupon_code_used',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Auction.is_completed'
        db.delete_column('auctions_auction', 'is_completed')

        # Deleting field 'Auction.winner'
        db.delete_column('auctions_auction', 'winner_id')

        # Deleting field 'Auction.coupon_code'
        db.delete_column('auctions_auction', 'coupon_code')

        # Deleting field 'Auction.coupon_code_used'
        db.delete_column('auctions_auction', 'coupon_code_used')
