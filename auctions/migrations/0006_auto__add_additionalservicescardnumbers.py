...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AdditionalServicesCardNumbers'
        db.create_table('auctions_additionalservicescardnumbers', (
        ...
        db.send_create_signal('auctions', ['AdditionalServicesCardNumbers'])


    def backwards(self, orm):
        # Deleting model 'AdditionalServicesCardNumbers'
        db.delete_table('auctions_additionalservicescardnumbers')
