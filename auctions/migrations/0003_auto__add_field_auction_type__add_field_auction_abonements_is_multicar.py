...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Auction.type'
        db.add_column('auctions_auction', 'type',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Auction.abonements_is_multicard'
        db.add_column('auctions_auction', 'abonements_is_multicard',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Auction.partner'
        db.add_column('auctions_auction', 'partner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['partners.Partner'], null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field addresses on 'Auction'
        db.create_table('auctions_auction_addresses', (
        ...
        db.create_unique('auctions_auction_addresses', ['auction_id', 'partneraddress_id'])


    def backwards(self, orm):
        # Deleting field 'Auction.type'
        db.delete_column('auctions_auction', 'type')

        # Deleting field 'Auction.abonements_is_multicard'
        db.delete_column('auctions_auction', 'abonements_is_multicard')

        # Deleting field 'Auction.partner'
        db.delete_column('auctions_auction', 'partner_id')

        # Removing M2M table for field addresses on 'Auction'
        db.delete_table('auctions_auction_addresses')
