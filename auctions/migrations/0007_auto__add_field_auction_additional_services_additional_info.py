...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Auction.additional_services_additional_info'
        db.add_column('auctions_auction', 'additional_services_additional_info',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['offers.AdditionalServicesInfo'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Auction.additional_services_additional_info'
        db.delete_column('auctions_auction', 'additional_services_additional_info_id')
