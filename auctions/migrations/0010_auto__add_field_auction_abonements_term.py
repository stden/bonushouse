...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Auction.abonements_term'
        db.add_column('auctions_auction', 'abonements_term',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Auction.abonements_term'
        db.delete_column('auctions_auction', 'abonements_term')
