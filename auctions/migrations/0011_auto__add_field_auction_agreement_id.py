...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Auction.agreement_id'
        db.add_column('auctions_auction', 'agreement_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Auction.agreement_id'
        db.delete_column('auctions_auction', 'agreement_id')
